...
function sprawdz2()
{
	...
	var Wyrażenie = new RegExp(/^[A-ZŁŻŹĆŚ][a-ząęóśłżźćń]{1,50}([-]{1}|[ ]{1})[A-ZŁŻŹĆŚ]{0,1}[a-ząęóśłżźćń]{1,50}$/);
	wynik = Wyrażenie.test(txt);
	if(wynik)
	{
		obj.style = "background-color: white";
...
function sprawdz3()
{
	...
	var Wyrażenie = new RegExp(/\d{0,4}[A-ZĄŁŻŹĆŚ]{0,1}[a-zęóąśłżźćń]{1,30}/);
	wynik = Wyrażenie.test(txt);
	if(wynik)
	{
		obj.style = "background-color: white";
...
function sprawdz4()
{
	...
	var Wyrażenie = new RegExp(/^[1-9][0-9]{0,10}$/);
	wynik = Wyrażenie.test(txt);
	if(wynik)
	{
		obj.style = "background-color: white";
...
function sprawdz6()
{
	...
	var Wyrażenie = new RegExp(/^[A-ZĄŁŻŹĆŚ][a-zęóąśłżźćń]{1,30}([-]{0,1}|[ ]{0,1})[A-ZĄŁŻŹĆŚ]{0,1}[a-zęóąśłżźćń]{1,30}$/);
	wynik = Wyrażenie.test(txt);
	if(wynik)
	{
		obj.style = "background-color: white";
...
function sprawdz7()
{
	...
	var Wyrażenie = new RegExp(/(?<!\w)(\(?(\+|00)?48\)?)?[ -]?\d{3}[ -]?\d{3}[ -]?\d{3}(?!\w)/);
	wynik = Wyrażenie.test(txt);
	if(wynik)
	{
		obj.style = "background-color: white";
